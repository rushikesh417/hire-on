  ...
  return (
    <Grid container item direction="column" alignItems="center" justify="center">
      ...
      <video className='videoTag' autoPlay loop muted 
        ...
        <div class="caption header-text shadow-lg"
